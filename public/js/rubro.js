...
$("#side-ele-lugares-rubroes").addClass("active");


function completar_campos(rubro) {
    $('#nombre').val(rubro.nombre);
    $('#form-update').attr('action', '/admin/rubros/' + rubro.id);
    $('#boton-modal-update').click();
}

function abrir_modal_borrar(id) {
    $('#form-borrar').attr('action', '/admin/rubros/' + id);
