...
<div class="invoice-box">
    <table cellpadding="0" cellspacing="0">
        <tr class="top">
            <td colspan="2">
                <table>
                    <tr>
                        <td class="title">
                            <img src="{{ asset('imagenes/logo.png')}}" style="width:50%; max-width:150px;">
                        </td>

                        <td>
                            <h2>¡Gracias por registrarse! Estos son los datos de su cuenta, conservelos a mano.</h2>
        ...
        <tr class="heading">
            <td>
                Credenciales de Acceso ALEX DISTRIBUIDORA SA
            </td>
