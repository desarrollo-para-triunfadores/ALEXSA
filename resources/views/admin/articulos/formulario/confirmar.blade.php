        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-borrar" action="" method="POST" accept-charset="UTF-8">
                    ...
                    <p>Usted está a punto de proceder con la eliminación permanente del artículo seleccionado. Si se encuentra completamente seguro prosiga con la acción.</p>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline" onclick="$('#boton_submit_borrar').click()">Eliminar Artículo, estoy seguro</button>
            </div>
        </div>
    </div>
</div>
