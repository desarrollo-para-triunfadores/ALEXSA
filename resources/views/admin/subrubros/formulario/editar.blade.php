    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Actualizar el Subrubro</h4>
            </div>
            <div class="modal-body">
                ...
                <form id="form-update" action="" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Rubro:</label>
                        <select style="width: 100%" id="rubro_id" name="rubro_id"  placeholder="campo requerido"  class="select2 form-control">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn  btn-warning" onclick="$('#boton_submit_update').click()">Actualizar Subrubro</button>
            </div>
        </div>
    </div>
</div>
