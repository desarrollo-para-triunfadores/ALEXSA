    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Enviar mensaje con presupuesto 📧</h4>
            </div>
            <div class="modal-body">
                ...
                <form class="formarchivo form-horizontal" name="f_enviar_correo" method="POST" enctype="multipart/form-data" action="/admin/enviar_correo"  id="f_enviar_correo" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="firma" name="firma" placeholder="Firma" value="Direccion de Ventas, ALEX DISTRIBUIDORA SA"/>
                        </div>
                    </div>
                    {{--
                    <div class="form-group">
