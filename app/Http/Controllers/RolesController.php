...
class RolesController extends Controller {
    ...
    public function store(Request $request) {
        ...
        if($request->inquilinos == true) {
            $modulos = $modulos." ".'Inquilinos |';
        }
        if($request->propietarios == true) {
            $modulos = $modulos." ".'Propietarios |';
        }
        if($request->consorcios == true) {
            $modulos = $modulos." ".'Consorcios |';
        }
        if($request->inmuebles == true) {
            $modulos = $modulos." ".'Inmuebles |';
        }
        if($request->servicios == true) {
            $modulos = $modulos." ".'Servicios |';
        }
